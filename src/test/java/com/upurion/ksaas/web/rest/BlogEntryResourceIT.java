...
import com.upurion.ksaas.domain.BlogEntry;
import com.upurion.ksaas.repository.BlogEntryRepository;
...
public class BlogEntryResourceIT {
    ...
    public void createBlogEntry() throws Exception {
        ...
        assertThat(testBlogEntry.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    ...
    public void updateBlogEntry() throws Exception {
        ...
        BlogEntry testBlogEntry = blogEntryList.get(blogEntryList.size() - 1);
        assertThat(testBlogEntry.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
