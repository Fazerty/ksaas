...
import com.upurion.ksaas.config.audit.AuditEventConverter;
import com.upurion.ksaas.domain.PersistentAuditEvent;
...
import static com.upurion.ksaas.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
