...
export default class DocumentationEntryComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('documentation-entry-heading'));
...
export class DocumentationEntryDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ksaasApp.documentationEntry.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-documentationEntry'));
}
