...
export default class FaqSectionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('faq-section-heading'));
...
export class FaqSectionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ksaasApp.faqSection.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-faqSection'));
}
