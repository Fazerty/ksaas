...
export default class BlogEntryComponentsPage extends AlertPage {
...
export class BlogEntryDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ksaasApp.blogEntry.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-blogEntry'));
}
