...
export default class TagComponentsPage extends AlertPage {
...
export class TagDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ksaasApp.tag.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-tag'));
}
