...
describe('Tag e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Tag page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/ksaasApp.tag.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/ksaasApp.tag.delete.question/);
