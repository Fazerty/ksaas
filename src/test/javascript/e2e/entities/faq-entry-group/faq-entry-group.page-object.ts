...
export default class FaqEntryGroupComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('faq-entry-group-heading'));
...
export class FaqEntryGroupDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ksaasApp.faqEntryGroup.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-faqEntryGroup'));
}
