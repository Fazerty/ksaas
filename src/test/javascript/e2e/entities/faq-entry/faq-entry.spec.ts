...
import FaqEntryComponentsPage, { FaqEntryDeleteDialog } from './faq-entry.page-object';
import FaqEntryUpdatePage from './faq-entry-update.page-object';
import FaqEntryDetailsPage from './faq-entry-details.page-object';
...
describe('FaqEntry e2e test', () => {
  let navBarPage: NavBarPage;
  let updatePage: FaqEntryUpdatePage;
  let detailsPage: FaqEntryDetailsPage;
  let listPage: FaqEntryComponentsPage;
  let deleteDialog: FaqEntryDeleteDialog;
  ...
  it('should load FaqEntries', async () => {
    await navBarPage.getEntityPage('faq-entry');
    listPage = new FaqEntryComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create FaqEntry page', async () => {
      await listPage.createButton.click();
      updatePage = new FaqEntryUpdatePage();

      await waitUntilAllDisplayed([updatePage.title, updatePage.footer, updatePage.saveButton]);

      expect(await updatePage.title.getAttribute('id')).to.match(/ksaasApp.faqEntry.home.createOrEditLabel/);
    });

    it('should create and save FaqEntries', async () => {
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        deleteDialog = new FaqEntryDeleteDialog();
        await waitUntilDisplayed(deleteDialog.dialog);

        expect(await deleteDialog.title.getAttribute('id')).to.match(/ksaasApp.faqEntry.delete.question/);
      ...
      it('should load details FaqEntry page and fetch data', async () => {
        const detailsButton = listPage.getDetailsButton(listPage.records.last());
        await click(detailsButton);

        detailsPage = new FaqEntryDetailsPage();
      ...
      it('should load edit FaqEntry page, fetch data and update', async () => {
